...
console.log("Linked List length:",myLinkedList.length);
console.log("non exist index:",myLinkedList.get(-1));
console.log("length is greater than existance:",myLinkedList.get(4));
console.log("give valid index:",myLinkedList.get(2));
console.log("give valid index:",myLinkedList.get(1));
